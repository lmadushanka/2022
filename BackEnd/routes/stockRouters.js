...
const { createStock, getAllStocks, getStockById, updateStock, getStockAmountByRouteProduct, deleteStock, getMainStock, getAllStocksGroupByProductWise, getStockByRoute } = require('../controllers/sotckController');
